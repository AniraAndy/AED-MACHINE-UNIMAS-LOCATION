...
// 2. Define Map Layers (Standard & Satellite)
...
// Add the standard map to the screen by default
standardMap.addTo(map);

// 3. Create the Layer Control Toggle
const baseMaps = {
  "Standard View": standardMap,
  "Satellite View": satelliteMap
};

// Add the toggle button to the top right of the map
L.control.layers(baseMaps, null, { position: 'topright' }).addTo(map);

// Define Custom Green Marker (Keep your existing marker code here)
...
const aedLocations = [
  ...
  },
  {
    ...
    "latitude": 1.4682614814428057, 
    "longitude": 110.44735534165429,
  ...
  },
  {
    ...
    "imageUrl": "images/pejabat_seksyen_kebudayaan.png"//"C:\Users\user\OneDrive\Documents\AED LOCATION\images\pejabat_seksyen_kebudayaan.png"
  },
  {
